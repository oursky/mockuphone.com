              ...
              (n = [
                    ...
                    var o = y.on(n, "open", function () {
                      ...
                      s = y.on(n, "error", function (n) {
                        r.cleanup(),
                          ...
                          i(u(b.prototype), "emit", e).call(e, "error", n),
                ...
                },
                {
                  ...
                  value: function () {
                    this.cleanup(),
                      ...
                      i(u(b.prototype), "emit", this).call(this, "open");
                    var t = this.engine;
                    this.subs.push(
                      y.on(t, "data", d(this, "ondata")),
                      y.on(t, "ping", d(this, "onping")),
                      y.on(t, "error", d(this, "onerror")),
                      y.on(t, "close", d(this, "onclose")),
                      y.on(this.decoder, "decoded", d(this, "ondecoded")),
                    );
                  },
                },
                {
                ...
                },
                {
                  ...
                  value: function (t, e) {
                    var n = this.nsps[t];
                    return (
                      n || ((n = new p.Socket(this, t, e)), (this.nsps[t] = n)),
                      n
                    );
                  },
                },
                ...
                },
                {
                  ...
                  value: function (t) {
                    this.cleanup(),
                      this.backoff.reset(),
                      (this._readyState = "closed"),
                      i(u(b.prototype), "emit", this).call(this, "close", t),
                      this._reconnection &&
                        !this.skipReconnect &&
                        this.reconnect();
                  },
              ...
              (n = [
                {
                  ...
                  value: function () {
                    if (!this.subs) {
                      var t = this.io;
                      this.subs = [
                        y.on(t, "open", d(this, "onopen")),
                        y.on(t, "packet", d(this, "onpacket")),
                        y.on(t, "close", d(this, "onclose")),
                      ];
                    }
                  },
